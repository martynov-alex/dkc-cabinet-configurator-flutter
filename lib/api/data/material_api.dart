...
/// [MaterialApi] объект, получаемый от DKC API при запросе по артикулу [code]
class MaterialApi {
  ...
  factory MaterialApi.fromJson(Map<String, dynamic> json) =>
      _$MaterialApiFromJson(json['material'] as Map<String, dynamic>);
}
